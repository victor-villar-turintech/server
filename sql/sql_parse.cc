    ...
    */
    if (thd->in_sub_stmt)
    {
      /*
        ...
        a function can be used in a PS safe context, and a dynamic statement
        which is not applicable in the current context is rejected at run
        time, in Prepared_statement::check_in_sub_stmt_or_error().
